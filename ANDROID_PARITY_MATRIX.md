...
| 8 | **Lazy Hydration & URL Prefetch** | IntersectionObserver + `prefetchSignedUrls` | Parallel coroutine signed URL prefetch + Coil async thumbnail loader | Complete | Loads thumbnails as items scroll into view |
